...
object Monster extends DefaultImage("monsterid")
object MysteryMan extends DefaultImage("mm")
object IdentIcon extends DefaultImage("identicon")
object Wavatar extends DefaultImage("wavatar")
object Retro extends DefaultImage("retro")
object FourOFour extends DefaultImage("404")
class CustomImage(url:String) extends DefaultImage(URLEncoder.encode(url, "UTF-8"))

case class Rating(value:String)
object G extends Rating("g")
object PG extends Rating("pg")
object R extends Rating("r")
object X extends Rating("x")
